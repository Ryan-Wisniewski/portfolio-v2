            ...
            <div className='projects'>
                    ...
                    <div className='project2'>
                        <div className='textAll'>
                            ...
                            <a className='link' href='https://github.com/Ryan-Wisniewski/nasa-photo-of-the-day' target="_blank" rel="noopener noreferrer">GitHub repository here</a>
                        </div>
                        <a className='imgAll' href='https://nasa-photooftheday.herokuapp.com/' target="_blank" rel="noopener noreferrer">
                            <p className='webLink'>Check out the website</p>
                    ...
                    <div className='project2'>  
                        <div className='textAll'>
                            ...
                            <a className='link' href='https://github.com/Split-The-Bill-Build-Week/Back-End' target="_blank" rel="noopener noreferrer">GitHub repository here</a>
                        </div>
                        <a className='imgAll' href='https://split-the-bill-be.herokuapp.com/' target="_blank" rel="noopener noreferrer">
